...
def test_get_latest_release_qa_pent(mock_client):
    result = mock_client.get_latest_release("Platform.Infrastructure", "qa",
                                            "pent")

    assert result == (123, 321)


def test_get_latest_release_pent_qa(mock_client):
